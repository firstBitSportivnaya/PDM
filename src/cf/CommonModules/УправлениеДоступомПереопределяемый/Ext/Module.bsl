...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "Отделы";
	ВидДоступа.Представление = НСтр("ru = 'Отделы'; en = 'Departments'");
	ВидДоступа.ТипЗначений   = Тип("СправочникСсылка.Отделы");
	
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "Проекты";
	ВидДоступа.Представление = НСтр("ru = 'Проекты'; en = 'Projects'");
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	Списки.Вставить(Метаданные.Документы.КадровыеИзменения			, Истина);
	Списки.Вставить(Метаданные.РегистрыСведений.КадроваяИнформация	, Истина);
