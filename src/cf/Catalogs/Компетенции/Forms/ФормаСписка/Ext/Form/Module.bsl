...
&НаКлиенте
Процедура ЗаполнитьСтандартныеКомпетенции(Команда)
	
	ЗаполнитьСтандартныеКомпетенцииНаСервере();
	Элементы.Список.Обновить();
	
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьСтандартныеКомпетенцииНаСервере()
	
	Справочники.Компетенции.ОбновлениеПредопределенных();
