...
Процедура ПередДобавлениемКомандОтчетов(КомандыОтчетов, Параметры, СтандартнаяОбработка) Экспорт
	...
	ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.КадровыеИзменения);
	ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.ОценкаСотрудников);
	ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.Обучения);
	ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.РегистрацияРабочегоВремени);
	Отчеты.ДвиженияДокумента.ДобавитьКомандуОтчетОДвиженияхДокумента(
		КомандыОтчетов, Параметры, ДокументыСОтчетомОДвижениях);
