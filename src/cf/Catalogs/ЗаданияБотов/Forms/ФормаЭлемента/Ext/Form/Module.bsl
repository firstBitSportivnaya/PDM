...
Процедура ТипЗаданияПриИзменении(Элемент)
	...
	ТипЗаданияПриИзмененииНаСервере();
	
КонецПроцедуры

&НаСервере
Процедура ТипЗаданияПриИзмененииНаСервере()
	
	ПростаяОтправка = Объект.ТипЗадания = Перечисления.ТипыЗаданийБота.Простое;
	Элементы.ГруппаДанныеПростойОтправки.Видимость	= ПростаяОтправка;
	Элементы.ШагиВыполнения.Видимость				= Не ПростаяОтправка;
	
КонецПроцедуры

&НаКлиенте
Процедура ПолучателиСпискомПриИзменении(Элемент)
	
	Элементы.ПолучателиАлгоритм.Видимость	= Не Объект.ПолучателиСписком;
	Элементы.Получатели.Видимость			= Объект.ПолучателиСписком;
...
&НаСервере
Процедура ВыполнитьКомандуВручнуюНаСервере()
	
	ИнтеграцияСБотамиСервер.ВыполнитьЗаданиеБота(Объект.Ссылка, Истина);
	
КонецПроцедуры

&НаКлиенте
Процедура ВыполнитьКомандуВручную(Команда)
	
	ВыполнитьКомандуВручнуюНаСервере();
...
Процедура ПодготовитьФормуНаСервере()
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) И Пользователи.РолиДоступны("ПолныеПрава, Администрирование") Тогда
