...
&НаКлиенте
Процедура ЗаполнитьСтандартныеСертификаты(Команда)
	
	ЗаполнитьСтандартныеСертификатыНаСервере();
	Элементы.Список.Обновить();
	
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьСтандартныеСертификатыНаСервере()
	
	Справочники.Сертификаты.ОбновлениеПредопределенных();
