...
//
// Параметры:
//  ТипСоответствия - Перечисление.ТипСоответствияОбъектовИБ - Тип соответствия.
...
Функция ПолучитьАдресПубликацииИнформационнойБазыДляБотов() Экспорт
	
	Возврат Константы.АдресПубликацииИнформационнойБазыДляБотов.Получить();
	
КонецФункции

Функция ПолучитьКоличествоДнейХраненияВыполненияЗаданийБотов() Экспорт
	
	Возврат Константы.КоличествоДнейХраненияВыполненияЗаданийБотов.Получить();
	
КонецФункции

Функция ПолучитьКоличествоДнейХраненияСообщенийБотов() Экспорт
	
	Возврат Константы.КоличествоДнейХраненияСообщенийБотов.Получить();
