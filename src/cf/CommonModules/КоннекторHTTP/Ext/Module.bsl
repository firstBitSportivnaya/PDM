...
Функция ПодготовитьЗапрос(Сессия, Метод, URL, ДополнительныеПараметры) Экспорт
	...
	ИмяФайлаТела = ВыбратьЗначение(Неопределено, ДополнительныеПараметры, "ИмяФайлаТела", "");
	ПараметрыЗаписиJSON = ВыбратьЗначение(Неопределено, ДополнительныеПараметры, "ПараметрыЗаписиJSON", Неопределено);

	ПодготовитьТелоЗапроса(ПодготовленныйЗапрос, Данные, Файлы, Json, ИмяФайлаТела, ПараметрыЗаписиJSON);
...
Процедура ПодготовитьТелоЗапроса(ПодготовленныйЗапрос, Данные, Файлы, Json, ИмяФайлаТела, ПараметрыЗаписиJSON)
	...
	ИначеЕсли Не ПустаяСтрока(ИмяФайлаТела) Тогда
